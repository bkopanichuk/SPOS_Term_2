...
public class ControlPanel extends Frame 
{
  ...
  Label counterValueLabel = new Label("0" , Label.LEFT) ;
  ...
  public void init( Kernel useKernel , String commands , String config ) 
  {
    ...
    counterValueLabel.reshape( 395,255+25,100,15 );
    add( counterValueLabel );

    pageCounterValueLabel.reshape( 395,240+25,100,15 );
    ...
    Label counterLabel = new Label("counter: " , Label.LEFT) ;
    counterLabel.reshape(285,255+25,110,15);
    add(counterLabel);
  ...
  public void paintPage( Page page ) 
  {
    ...
    pageCounterValueLabel.setText(String.valueOf(page.lastUsageCounter));
  }
