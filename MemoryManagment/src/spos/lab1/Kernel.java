...
public class Kernel extends Thread
{
  ...
  public void step()
  {
    ...
    MemoryManagement.counter.increaseCounter(); //increase counter after command
    ...
    if ( instruct.inst.startsWith( "READ" ) ) 
    {
      ...
      page.setLastUsageCounter(); //set lastUsageCounter in the table after appeal to the memory
      if ( page.physical == -1 ) 
      {
        if ( doFileLog )
        {
    ...
    controlPanel.counterValueLabel.setText(String.valueOf(MemoryManagement.counter.getCounter()));
  }
  ...
  public void reset() {
    ...
    MemoryManagement.counter.resetCounter();
    controlPanel.counterValueLabel.setText(String.valueOf(MemoryManagement.counter.getCounter()));
