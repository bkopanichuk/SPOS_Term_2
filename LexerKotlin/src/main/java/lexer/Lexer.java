...
public class Lexer {
            ...
            switch (curState) {
                case START: {
                    if (character >= '1' && character <= '9')
                        ...
                        curState = State.DOUBLE_QUESTION_MARK;
                    }
                    else if (character == ':') {
                        curState = State.DOUBLE_COLON;
                    }
    ...
    public void generateHTML() {
        String html = "<html><head><title>Lexer Kotlin</title><link href =\"style.css\" rel=\"stylesheet\" type=\"text/css\"></head><body><h1>Kotlin LEXER</h1>" +
                "<div style=\"background-color: black; margin-bottom: 20px; padding: 10px\"><span class=\"IDENTIFIER\">IDENTIFIER </span><span class=\"KEYWORD\">KEYWORD </span><span class=\"PUNCTUATION\">PUNCTUATION </span><span class=\"COMMENT\">COMMENT </span><span class=\"ERROR\">ERROR </span>" +
                "<span class=\"OPERATOR\">OPERATOR </span><span class=\"LITERAL\">LITERAL </span><span class=\"NUMBER\">NUMBER</span></div><div>";
        for (Token token : tokens) {
        ...
        try {
            fileWriter = new FileWriter("src/main/resources/output.html");
